...
static const char *group_5_commands[] = {
    ...
    /* b2-b4 */ "Search data low(12)",
    "Set limits(12)",
    unknown,
    /* b5-b6 */ "Request volume element address",
    "Send volume tag",
    /* b7-b9 */ "Read defect data(12)",
    "Read element status",
    unknown,
    /* ba-bf */ unknown,
    unknown,
...
static const char *statuses[] = {
    ...
    "Intermediate",
    unknown,
    /* a-c */ "Intermediate-Condition Met",
    unknown,
                    ...
                    int sb_len)
{
    ...
    { /* extended sense data */
        ...
        fprintf(OUTP, "Info fld=0x%x, ", (int)((sense_buffer[3] << 24) | (sense_buffer[4] << 16) | (sense_buffer[5] << 8) | sense_buffer[6]));
        ...
        if (sense_buffer[7] + 7 < 13 ||
            (sense_buffer[12] == 0 && sense_buffer[13] == 0))
            goto done;
